...
<td class="ContainerInline"><include file="Im:pub_sidebar" /></td>
<td class="ContainerRight">
<div id="pageTitle"><h1>{$Think.lang.PAGETITLE_IM_INDEX}</h1></div>
...
<div class="headingsLeft">{$Think.lang.TABLETITLE_IM_INDEX}</div>
<div class="clear"></div>
</div>
