...
<div id="pageTitle"><h1>{$Think.lang.PAGETITLE_ARTICLE_RECYCLE}</h1></div>
...
<div class="headingsLeft">{$Think.lang.TABLETITLE_ARTICLE_RECYCLE}</div>
<div class="clear"></div>
</div>
