...
<div id="con_one_1" class="hover">
	<ul class="sideItemUl">
		...
		<?php echo W("Sidebar/sideCateTable",array("Page","display",$pid));?>
	</ul>
</div>
...
<?php echo W("Sidebar/sideCateTable",array("Page","edit"));?>
<tr>
...
<form enctype="multipart/form-data" method="POST" name="searchform" id="searchform" action="javascript:void(0)" onsubmit='searchFormValidate("/index.php/Adminx/Page/index")' >
...
<td><a href="/index.php/Adminx/Page/index?pid=<?php echo ($vo["pid"]); ?>" title="<?php echo (L("TIP_TITLE_CATE")); ?>"><?php echo getCateTitle($vo['pid']);?></a></td>
<td><a href="/index.php/Adminx/Page/index?protect=<?php echo ($vo["isProtect"]); ?>" title="<?php echo (L("TIP_TITLE_STATE")); ?>"><?php echo getState($vo['isProtect'],"protect");?></a></td>
...
<script>$(function(){ $.divselect("#iifun","#ifun"); });</script>
        <div id="iifun" class="dropdown" tabindex="0" style="width:120px" ><p><?php echo (L("JSELECT_OPTION")); ?></p><ul  class="" style="width:120px"><?php echo getListBatchBtn("sort,recycle,protect");?></ul></div> 
