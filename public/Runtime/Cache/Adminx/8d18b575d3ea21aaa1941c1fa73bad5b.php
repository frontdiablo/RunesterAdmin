...
<div id="pageTitle">
<h1><?php echo (L("PAGETITLE_ADMIN_GROUP_AUTH")); ?></h1>
</div>
...
<form enctype="multipart/form-data" method="POST" name="myform"  action="/index.php/Adminx/AdminGroup/update_access">
<input type="hidden" name="id" value="<?php echo ($vo["id"]); ?>" />
<div class="TabTitle">
<ul>
<li id="one1" class="hover"><?php echo (L("TAB_AUTH_ACCESS")); ?></li>
</ul>
</div>
...
<?php echo getRuleCheck(0,$vo['rules']);?>
</table>
</div>
...
<input type='submit' class='btn btnBlue' value='<?php echo (L("BTN_AUTH")); ?>' />
</div>
</form>
</div>
