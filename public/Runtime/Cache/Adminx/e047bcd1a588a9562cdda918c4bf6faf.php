...
<div id="pageTitle">
<h1><?php echo (L("PAGETITLE_PAGE_ADD")); ?></h1>
</div>
...
<form enctype="multipart/form-data" method="POST" name="myform"  action="/index.php/Adminx/Page/insert">
...
<script>$(function(){ $.divselect("#ipid","#pid"); });</script>
        <div id="ipid" class="dropdown" tabindex="0" style="" ><p>请选择所属分类</p><ul  class="" style=""><?php echo getCate("page");?></ul></div> 
