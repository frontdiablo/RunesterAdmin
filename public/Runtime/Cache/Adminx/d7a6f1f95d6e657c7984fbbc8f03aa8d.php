...
<script type="text/javascript" src="/Apps/Adminx/resource/function/ajax/ajax.js"></script>
<script type="text/javascript">var AjaxClearCacheUrl = "<?php echo U('Cache/clear_cache');?>";</script>
<style type="text/css">
body{background: url("/Apps/Adminx/resource/images/bg_1.png");width:100%;height: 100%;overflow: hidden;}
</style>
