...
<ul class="navButton">
<li><a href='/index.php/Adminx/GuestbookShortcut/index' class='commentBtn navButton1'>留言管理</a></li>
<li><a href='/index.php/Adminx/GuestbookShortcut/index' class='commentBtn navButton2'>快捷留言管理</a></li>
<li><a href='/index.php/Adminx/GuestbookShortcut/head' class='commentBtn navButton3'>留言头像管理</a></li>
<div class="clear"></div>
</ul>
<div class="clear"></div>
...
<form enctype="multipart/form-data" method="POST" name="searchform" id="searchform" action="javascript:void(0)" onsubmit='searchFormValidate("/index.php/Adminx/GuestbookShortcut/index")' >
...
<script>$(function(){ $.divselect("#iifun","#ifun"); });</script>
        <div id="iifun" class="dropdown" tabindex="0" style="width:120px" ><p><?php echo (L("JSELECT_OPTION")); ?></p><ul  class="" style="width:120px"><?php echo getListBatchBtn("sort,recycle");?></ul></div> 
