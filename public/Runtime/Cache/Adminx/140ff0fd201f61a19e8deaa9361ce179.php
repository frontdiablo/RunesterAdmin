...
<div id="pageTitle">
<h1><?php echo (L("PAGETITLE_ARTICLE_EDIT")); ?></h1>
</div>
...
<form enctype="multipart/form-data" method="POST" name="myform"  action="/index.php/Adminx/Article/update">
<input type="hidden" name="id" value="<?php echo ($vo["id"]); ?>" />
<input type="hidden" name="content_id" value="<?php echo ($vo["content_id"]); ?>" />
<div class="TabTitle">
<ul>
...
<?php if(C('HIDE_FIELD.ARTICLE_TITLE_COLOR') != 'true'): ?>
		<input type='text' id='ititleColor'  class='input colorInput' value='标题颜色' readonly='readonly' style='background:<?php echo ($vo["titleColor"]); ?>'  />
		<input type='hidden' id='titleColor' name='titleColor' value='<?php echo ($vo["titleColor"]); ?>' />
		<script type='text/javascript'>
...
<script>$(function(){ $.divselect("#ipid","#pid"); });</script>
        <div id="ipid" class="dropdown" tabindex="0" style="" ><p><?php echo getCateTitle($vo['pid']);?></p><ul  class="" style=""><?php echo getCate("Article");?></ul></div> 
...
<td class="inputTd">
<input type="text" class="input dateInput" name="pubDate" value="<?php echo ($vo["pubDate"]); ?>" <?php echo ($DateActive); ?> />
</td>
</tr>
<tr>
<td class="titleTd"><?php echo (L("FIELD_INFO")); ?></td>
<td class="inputTd">
<?php echo (L("FIELD_ARTICLE_SOURCE")); ?><input type="text" class="input" name="source" value="<?php echo ($vo["source"]); ?>" />
&#12288;&#12288;<?php echo (L("FIELD_AUTHOR")); ?><input type="text" class="input dateInput" name="author" value="<?php echo ($vo["author"]); ?>" />
</td>
</tr>
<tr>
...
<script>$(function(){ $.divselect("#itarget","#target"); });</script>
        <div id="itarget" class="dropdown" tabindex="0" style="" ><p><?php echo getTarget($vo['target']);?></p><ul  class="" style=""><?php echo getTarget();?></ul></div> 
        <input type="hidden" id="target" name="target" value="<?php echo ($vo['target']); ?>" />
&#12288;&#12288;
<?php echo (L("FIELD_TOP")); ?>
<script>$(function(){ $.divselect("#iisTop","#isTop"); });</script>
        <div id="iisTop" class="dropdown" tabindex="0" style="" ><p><?php echo getIsTop($vo['isTop']);?></p><ul  class="" style=""><?php echo getIsTop();?></ul></div> 
        <input type="hidden" id="isTop" name="isTop" value="<?php echo ($vo['isTop']); ?>" />
&#12288;&#12288;
<?php echo (L("FIELD_HIDE")); ?>
<script>$(function(){ $.divselect("#iisHide","#isHide"); });</script>
        <div id="iisHide" class="dropdown" tabindex="0" style="" ><p><?php echo getIsHide($vo['isHide']);?></p><ul  class="" style=""><?php echo getIsHide();?></ul></div> 
        <input type="hidden" id="isHide" name="isHide" value="<?php echo ($vo['isHide']); ?>" />
</td>
</tr>
...
<td class="inputTd"><textarea name="description" class="noteTextarea resizenone" ><?php echo ($vo["description"]); ?></textarea></td>
</tr><?php endif; ?>
<tr>
<td class="titleTd"><?php echo ($must); echo (L("FIELD_CONTENT")); ?></td>
<td class="inputTd">
        <textarea name='content' class='noteTextarea'><?php echo ($vo["content"]); ?></textarea>
        <script type='text/javascript'>
		    KindEditor.ready(function(K) {
...
<td class="inputTd"><input type="text" class="input urlInput" name="url" value="<?php echo ($vo["url"]); ?>" /></td>
</tr>
